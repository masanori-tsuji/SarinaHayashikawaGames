...
CSound::SOUNDPARAM CSound::m_aParam[SOUND_LABEL_MAX] = // 各音素材のパラメータ
{
	...
	{ "data/SE/recovery.wav", 0 },
    { "data/SE/select.wav", 0 },//選択音
    { "data/SE/enter.wav", 0 },//決定音
    { "data/SE/waon.wav", 0 },//決定音
    { "data/SE/syan.wav", 0 },//しゃん
	{ "data/SE/bomb.wav", 0 },//しゃん
	{ "data/SE/playershot.wav", 0 },//しゃん
	{ "data/SE/bomb2.wav", 0 },//しゃん
    { "data/SE/clow.wav", 0 },//しゃん
    { "data/BGM/bossbgm.wav", -1},//しゃん
	{ "data/BGM/bossbgm1.wav", -1 },//しゃん
{ "data/BGM/docyu.wav", -1 }//しゃん
};
